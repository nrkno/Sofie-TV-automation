...
## Gateways
* [*Sofie* MOS Gateway](https://github.com/nrkno/tv-automation-mos-gateway) [MOS protocol](http://mosprotocol.com/) gateway between *Server Core* and MOS devices.
...
* [*Sofie* MOS Connection library](https://github.com/nrkno/tv-automation-mos-connection/) [MOS protocol](http://mosprotocol.com/) Library for connecting to a MOS device.
